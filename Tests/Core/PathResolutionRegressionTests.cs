...
namespace FFTColorCustomizer.Tests.Core
{
    ...
    public class PathResolutionRegressionTests
    {
        ...
        public void Mod_GetUserConfigPath_Logic_Validates_Correctly()
        {
            ...
            var expectedUserPath = $@"C:\Reloaded\User\Mods\{ColorModConstants.ModNamespace}\Config.json";
            ...
            var calculatedUserPath = Path.Combine(grandParent, "User", "Mods", ColorModConstants.ModNamespace, "Config.json");

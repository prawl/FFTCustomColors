...
HP=105/432**. He may be the last man standing — other allies likely
KO'd from prior runs. 3 live enemies on the field. Your first action
is `screen` to see what you're working with. The game is on Windows,
running via Reloaded-II. The bridge is single-threaded — wait for each
command's response before sending the next.
...
### `playtest_logs/2026-04-26_0905/play.md`
...
### `playtest_logs/2026-04-26_0905/feedback.md`
...
- **Don't ask the parent for guidance** — operate solo. If genuinely
  stuck, log the situation and recover (e.g. `battle_flee` or the

...
with a partial party: **Ramza is the active player unit**. Lloyd and
Wilham are alive; Kenrick was KO'd in a prior run. 5 enemies (2 Archers,
Knight, Summoner mid-cast, Time Mage). Your first action is `screen` to
see what you're working with. The game is on Windows, running via
Reloaded-II. The bridge is single-threaded — wait for each command's
...
### `playtest_logs/2026-04-26_0021/play.md`
...
### `playtest_logs/2026-04-26_0021/feedback.md`

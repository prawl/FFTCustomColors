...
The user has placed you in an active battle with **Ramza** as your
playable character. Your first action is `screen` to see what you're
working with. The game is on Windows, running via Reloaded-II. The
bridge is single-threaded — wait for each command's response before
sending the next.
...
### `playtest_logs/2026-04-25_1740/play.md`
...
### `playtest_logs/2026-04-25_1740/feedback.md`

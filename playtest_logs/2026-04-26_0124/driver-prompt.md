...
mid-fight. **Lloyd (Orator) is the active player unit**. Other allies
are alive but wounded. 5 enemies on the field. Your first action is
`screen` to see what you're working with. The game is on Windows,
...
### `playtest_logs/2026-04-26_0124/play.md`
...
### `playtest_logs/2026-04-26_0124/feedback.md`

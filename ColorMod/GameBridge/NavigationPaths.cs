    ...
    public static class NavigationPaths
    {
        ...
        private static Dictionary<string, PathEntry>? GetPathsRaw(DetectedScreen screen)
        {
            ...
            return screen.Name switch
            {
                ...
                "WarriorsGuildRecruit" => GetShopItemListPaths("Select job to recruit (opens stat-offer dialog)"),
                "WarriorsGuildRename" => GetShopItemListPaths("Select unit to rename (opens name editor)"),
                "PoachersDenProcessCarcasses" => GetShopItemListPaths("Select carcass to process into item"),
                "PoachersDenSellCarcasses" => GetShopItemListPaths("Select carcass to sell"),

...
- [ ] **screen header should show [Battle_MyTurn] not [Battle]** [State] — The unified screen command shows `[Battle]` as the header but should show the actual screen state `[Battle_MyTurn]` so you can tell what state the game is in. Observed 2026-04-12.

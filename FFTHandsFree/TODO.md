...
- [ ] **Damage detection in battle_attack response** [State] — Static array at 0x140893C00 has STALE HP — doesn't update during/after attacks. Killed a Skeleton (HP 535→0 on screen) but static array still read 535. Condensed struct at 0x14077D2AC shows active unit, not target. Need to find the live HP address the game UI reads from. Observed 2026-04-12.

...
- [~] **🟡 `battle_wait` slow — 17-33s per end-of-turn** [Speed] — Live-repro pre-restart: 17s / 20s / 21s / 33s across consecutive turns. 2026-04-24 measured ~10s/turn after the 300→150ms poll interval drop. AUDITED 2026-04-24: poll overhead is already tight (150ms sleep + cached `_detectScreen` + every-3rd-tick narrator batch). Remaining cost is pure animation playback. Hotkey-hunt run 2026-04-25 (Siedge Weald, baseline battle_wait=37.7s): tested Tab (0x09) — opened pause menu (false-fast 28s because game was paused); LShift (0xA0) — 40s no change; R (0x52) — opened Move mode, no change. No fast-forward hotkey discovered among Tab/LShift/R candidates. Remaining candidates to try next session: Space (0x20, already used for menu confirm so probably not), LAlt (0xA4), Backspace (0x08), F1-F4, numpad keys, gamepad trigger emulation (XInput). May also be that IC remaster simply doesn't have a fast-forward — the 2026-04-22 speed-setting change in Options might be the only handle.

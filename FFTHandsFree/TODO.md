...
- [ ] **Show active unit name/job in screen state** — Screen output should show whose turn it is (e.g. "Ramza (Heretic)" or "Lloyd (Archer)") so Claude doesn't have to scan to know.

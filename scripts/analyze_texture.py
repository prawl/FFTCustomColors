...
def main():
    ...
    # Analyze the white_heretic tex file
    filename = r"C:\Users\ptyRa\Dev\FFTColorCustomizer\ColorMod\FFTIVC\data\enhanced\system\ffto\g2d\white_heretic\tex_830.bin"

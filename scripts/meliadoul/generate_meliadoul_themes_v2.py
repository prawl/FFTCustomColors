#!/usr/bin/env python3
"""Generate 50 MORE varied themes for Meliadoul with different color combinations."""
...
def generate_all_themes():
    """Generate 50 MORE creative themes for Meliadoul with preserved face colors."""
    ...
    # Define 50 MORE unique themes
    themes = [
        # Ancient/Mythological themes
        ("ancient_bronze", "#CD7F32", "#8B7355"),
        ("spartan_warrior", "#8B0000", "#CD7F32"),
        ("amazonian_guard", "#228B22", "#FFD700"),
        ("olympian_gold", "#FFD700", "#87CEEB"),
        ("titan_forged", "#36454F", "#FF4500"),

        # Eastern-inspired armors
        ("samurai_red", "#DC143C", "#000000"),
        ("shogun_black", "#1C1C1C", "#DC143C"),
        ("ninja_shadow", "#2F4F4F", "#4B0082"),
        ("ronin_gray", "#696969", "#8B4513"),
        ("dynasty_jade", "#00A86B", "#FFD700"),

        # Nordic/Viking themes
        ("valkyrie_frost", "#87CEEB", "#C0C0C0"),
        ("berserker_rage", "#8B0000", "#696969"),
        ("runic_steel", "#708090", "#4169E1"),
        ("thor_thunder", "#1E90FF", "#FFD700"),
        ("odin_wisdom", "#4B0082", "#C0C0C0"),

        # Fantasy creature armors
        ("dragon_scale", "#8B0000", "#FFD700"),
        ("phoenix_feather", "#FF4500", "#FFD700"),
        ("unicorn_silver", "#C0C0C0", "#E6E6FA"),
        ("griffin_bronze", "#CD7F32", "#8B4513"),
        ("hydra_green", "#228B22", "#4B0082"),

        # Seasonal themes
        ("autumn_harvest", "#FF8C00", "#8B4513"),
        ("winter_frost", "#B0E0E6", "#FFFFFF"),
        ("spring_bloom", "#FFB6C1", "#98FB98"),
        ("summer_sun", "#FFD700", "#87CEEB"),
        ("equinox_balance", "#4B0082", "#FFD700"),

        # Cosmic/Space themes
        ("nebula_purple", "#9400D3", "#FF1493"),
        ("starlight_silver", "#C0C0C0", "#F0F8FF"),
        ("void_black", "#000000", "#4B0082"),
        ("solar_flare", "#FF4500", "#FFD700"),
        ("lunar_eclipse", "#191970", "#C0C0C0"),

        # Alchemical/Magic themes
        ("philosopher_stone", "#DC143C", "#FFD700"),
        ("mercury_quicksilver", "#C0C0C0", "#87CEEB"),
        ("sulfur_yellow", "#FFD700", "#FF4500"),
        ("salt_white", "#FFFFFF", "#C0C0C0"),
        ("azoth_purple", "#9400D3", "#C0C0C0"),

        # Modern tactical themes
        ("urban_camo", "#696969", "#2F4F4F"),
        ("desert_storm", "#F4A460", "#8B4513"),
        ("arctic_ops", "#F0F8FF", "#4682B4"),
        ("jungle_warfare", "#228B22", "#8B4513"),
        ("night_ops", "#000000", "#191970"),

        # Precious metal variations
        ("rose_gold", "#B76E79", "#FFB6C1"),
        ("white_gold", "#F8F8FF", "#FFD700"),
        ("black_gold", "#1C1C1C", "#FFD700"),
        ("copper_oxide", "#4C8B72", "#CD7F32"),
        ("brass_antique", "#B5651D", "#CD7F32"),

        # Unique color combinations
        ("twilight_zone", "#483D8B", "#FF69B4"),
        ("aurora_borealis", "#00FF7F", "#9370DB"),
        ("sunset_horizon", "#FF6347", "#4B0082"),
        ("ocean_depth", "#000080", "#40E0D0"),
        ("forest_shadow", "#013220", "#8FBC8F"),
    ]
    ...
    print(f"\n[COMPLETE] Generated 50 MORE themes for Meliadoul (armor colors only)")

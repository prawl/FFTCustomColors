#!/usr/bin/env python3
"""
Create a simple color test for Beowulf with distinct colors.
...
def create_simple_test_sprite():
    ...
    source_sprite = os.path.join(sprites_dir, "battle_beio_spr.bin")

    # Create test theme directory
    test_dir = os.path.join(sprites_dir, "sprites_beowulf_test")
    ...
    print("Creating SIMPLE color test for Beowulf:")
    print("=" * 50)
    ...
    output_path = os.path.join(test_dir, "battle_beio_spr.bin")
    with open(output_path, 'wb') as f:
        f.write(sprite_data)

    print(f"  [OK] Created battle_beio_spr.bin")
    ...
    print("2. Launch the game with Beowulf in your party")
    ...
    with open(reference_file, 'w') as f:
        f.write("BEOWULF SIMPLE COLOR TEST\n")
        f.write("=" * 30 + "\n\n")
        ...
        f.write("\n" + "=" * 30 + "\n")
        f.write("Note which parts of Beowulf show each color!\n")
